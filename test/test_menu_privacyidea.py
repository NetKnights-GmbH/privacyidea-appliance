...
class TestMenuPrivacyIDEA(MenuTestCase):
    ...
    def test_set_loglevel(self, _mock_method):
        ...
        self.simulate_run(user1, config_file=TEST_CONFIG)
        p_config1 = PrivacyIDEAConfig(TEST_CONFIG)
        ...
        self.simulate_run(user2, config_file=TEST_CONFIG)
        p_config2 = PrivacyIDEAConfig(TEST_CONFIG)
